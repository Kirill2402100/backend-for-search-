            ...
            <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:560px; background-color:#101010; border-radius:8px; font-family:Arial,sans-serif;">
                <tr>
                    <td align="center" style="padding:24px;">
                        ...
                        <p style="font-size:18px; font-weight:bold; color:#a9f07c; margin:0 0 16px 0; letter-spacing:1px;">
                            tapgrow
                        </p>
                        ...
                        <p style="font-size:18px; font-weight:600; color:#ffffff; line-height:1.2; margin:0 0 4px 0;">
                            Svetlana Miroshkina
                        </p>
                        <p style="font-size:14px; color:#bbbbbb; margin:0 0 20px 0;">
                            Project Manager
                        </p>
